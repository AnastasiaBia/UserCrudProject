...
<html>
    ...
    <body>
        ...
        <!--    Table of users available for update-->
                ...
                <tbody>
                    <c:forEach items="${olausers}" var="ur">
                         <tr class="table-info">
                            ...
                            <!--            Link that acts as a button and brings the user id to the controller method /preupdate-->

                            <td><a href="/preupdate/${ur.userId}" class="w3-button w3-round-xlarge,
                                   w3-button w3-pink" style="border-radius: 12px;" 
                                   data_but="btn-xs"><i class='fa fa-check-square'></i> Update</a></td>
