<%-- 
    Document   : updateform
    Created on : Feb 25, 2020, 12:30:58 AM
    Author     : Natasa
--%>
...
<!--        Update form which has the selected user data to be updated-->
        <div style="padding-top: 200px; text-align: center;" class="example">
            ...
            <form:form method="POST" action="/updateuser"
                ...
                <div style="padding: 2%;">
                    ...
                    <form:input path="userEmail" class="form-control form-control-sm" type="email" name="uemail" id="uemail" placeholder="Email" required="required"/>
                </div>
                <div style="padding: 2%;">
                ...
                <div style="padding: 2%;">
                    <span>
<!--                        Submit button which will perform the update - controller method /updateuser-->
                    ...
                    <span>
                        <!--                        Button which takes the user back to the list of users available for update -updateusers.jsp-->
                        <td><a href="/updateusers" class="w3-button w3-round-xlarge,
            ...
            <script src="../../../resources/static/alertsuccess.js" type="text/javascript"></script>
            <!-- Sweet alerts  -->
